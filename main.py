...
motor_anexo_esquerda = Motor(Port.A)
...
#=======================FUNÇÕES DE STARTS==========================#
def start5(): #start5 #START DAS PEDRAS CONSISTE EM ATIVAR O ESCORREAMNTO DAS ROCHAS,
    drive_base.use_gyro(True)
...
def start1(): #start1 #START DAS MISSÕES DA ESCAVAÇÃO SUPERFICIAL E DA REVELAÇÃO DO MAPA
    ...
    drive_base.straight(160) #IR PARA A FRENTE EM DIREÇÃO A MISSÃO DA REVELAÇÃO DO MAPA
    ...
    drive_base.straight(600) #IR PARA A BASE
...
def start6(): #start 6 #START MISSÃO GANGORRA E OQUE ESTÁ A VENDA
    ...
    giroPID(-46,2,0.0003,120) #GIRAR PARA A ESQUERDA EM DIREÇÃO A MISSÃO DA GANGORRA
    wait(300)
    ...
    #giroPID(-9,2,0.0003,120) #GIRAR PARA A ESQUERDA EM DIREÇÃO A MISSÃO DA GANGORRA
...
def start4(): #start4 #travessia
   ...
   resetar_guinada()
   drive_base.settings(400,1200) #MUDAR VELOCIDADE PARA IR PARA TRÁS 
   ...
   drive_base.straight(400) #IR PARA FRENTE EM DIREÇÃO A MISSÃO EXTRAÇÃO SEGURA
   drive_base.straight(-130) #VOLTAR PARA TRÁS
   resetar_guinada() #DEFINIR GUINADA PARA ZERO
   giroPID(59,0.7,0.0003,120) #GIRAR PARA A DIREITA
   drive_base.straight(335)#IR PARA A FRENTE
   resetar_guinada()
   ...
   drive_base.settings(350,1000)
   drive_base.straight(220)#IR PARA FRENTE
   #drive_base.straight(-25) #VOLTAR PARA TRAS
   #resetar_guinada() #DEFINIR GUINADA PARA ZERO
   giroPID(-9,2,0.003,120) #GIRAR PARA ESQUERDA
...
def start7():
    ...
    resetar_guinada()
    giroPID(-90, 1.5, 0.0001, 1)
    drive_base.settings(500,300)
    drive_base.straight(455)
    motor_anexo_esquerda.run_time(500, 500)
    drive_base.settings(400,2000)
    drive_base.straight(-120)
    resetar_guinada()
    giroPID(-41, 1.5, 0.0001, 1)
    drive_base.straight(610)
    resetar_guinada()
    giroPID(-65, 1.5, 0.001, 1)
    #drive_base.settings()
    drive_base.straight(140)
    drive_base.use_gyro(False)
    motor_anexo_direita.run_angle(-500, 200)
    motor_anexo_esquerda.run_time(-200, 2000)
    drive_base.straight
...
def start8():
    ...
    wait (200)
    motor_anexo_esquerda.run_time(350,1000)
    drive_base.straight(-170)

  
def start9():
    
    drive_base.settings(440,800)
    #drive_base.straight(200)
